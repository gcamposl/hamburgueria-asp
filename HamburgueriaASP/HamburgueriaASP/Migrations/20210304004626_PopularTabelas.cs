...
namespace HamburgueriaASP.Migrations
{
    public partial class PopularTabelas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("insert into Lanches(Nome, DescricaoCurta, DescricaoDetalhada, ImagemUrl, ImagemThumbnailUrl, Preco, IsLanchePreferido, EmEstoque, CategoriaId) values('Cheese Salada', 'Pão, hambúrger, ovo, presunto, queijo e batata palha','Delicioso pão de hambúrger com ovo frito; presunto e queijo de primeira qualidade acompanhado com batata palha','http://www.macoratti.net/Imagens/lanches/cheesesalada1.jpg','http://www.macoratti.net/Imagens/lanches/cheesesalada1.jpg',12.50,0,0, SELECT CategoriaId FROM Categoria WHERE CategoriaNome = 'Normal')");
            migrationBuilder.Sql("insert into Lanches(Nome, DescricaoCurta, DescricaoDetalhada, ImagemUrl, ImagemThumbnailUrl, Preco, IsLanchePreferido, EmEstoque, CategoriaId) values('Misto Quente', 'Pão, presunto, mussarela e tomate', 'Delicioso pão francês quentinho na chapa com presunto e mussarela bem servidos com tomate preparado com carinho.', 'http://www.macoratti.net/Imagens/lanches/mistoquente4.jpg', 'http://www.macoratti.net/Imagens/lanches/mistoquente4.jpg', 8.00, 0, 1, SELECT CategoriaId FROM Categoria WHERE CategoriaNome = 'Normal')");
            migrationBuilder.Sql("insert into Lanches(Nome, DescricaoCurta, DescricaoDetalhada, ImagemUrl, ImagemThumbnailUrl, Preco, IsLanchePreferido, EmEstoque, CategoriaId) values('Cheese Burger', 'Pão, hambúrger, presunto, mussarela e batalha palha', 'Pão de hambúrger especial com hambúrger de nossa preparação e presunto e mussarela; acompanha batata palha.', 'http://www.macoratti.net/Imagens/lanches/cheeseburger1.jpg', 'http://www.macoratti.net/Imagens/lanches/cheeseburger1.jpg', 11.00, 1, 1, SELECT CategoriaId FROM Categoria WHERE CategoriaNome = 'Normal')");
            migrationBuilder.Sql("insert into Lanches(Nome, DescricaoCurta, DescricaoDetalhada, ImagemUrl, ImagemThumbnailUrl, Preco, IsLanchePreferido, EmEstoque, CategoriaId) values('Lanche Natural Peito Peru', 'Pão Integral, queijo branco, peito de peru, cenoura, alface, iogurte', 'Pão integral natural com queijo branco, peito de peru e cenoura ralada com alface picado e iorgurte natural.', 'http://www.macoratti.net/Imagens/lanches/lanchenatural.jpg', 'http://www.macoratti.net/Imagens/lanches/lanchenatural.jpg', 15.00, 0, 0, SELECT CategoriaId FROM Categoria WHERE CategoriaNome = 'Natural')");
